...
def track_and_scan_boundary_jump(scene, ed6, cam, motors_dof_idx, j6_link, cube_pos, jump_height=0.1, max_steps=30):
    ...
    for step in range(max_steps):
        ...
        o3d.visualization.draw_geometries([pcd], window_name=f"Step {step+1} PointCloud", width=800, height=600)
        ...
        if len(all_points) > 0:
            ...
            o3d.visualization.draw_geometries([accumulated_pcd], window_name="Accumulated Point Cloud", width=800, height=600)
