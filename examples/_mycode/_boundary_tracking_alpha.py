...
def track_and_scan_boundary_jump(scene, ed6, cam, motors_dof_idx, j6_link, cube_pos, jump_height=0.1, max_steps=10, method="alpha_shape"):
    """
    ...
    for step in range(max_steps):
        ...
        # 4. 检查是否回到初始点
        if start_recorded and step > 3:  # 至少3步后才检查
...
def generate_palpation_suggestions(anomalies, cube_pos, max_suggestions=3):
    """
    生成触诊建议位置
