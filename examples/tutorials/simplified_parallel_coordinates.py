...
Only showing Time, Coverage, and Point Count
"""
...
def create_simplified_parallel_coordinates():
    """Create simplified parallel coordinates plot with only 3 key metrics"""
    ...
    print("Simplified parallel coordinates created successfully!")

def create_clean_parallel_coordinates(data):
    """Create clean parallel coordinates plot with only 3 metrics"""
    ...
    # Extract data for the 3 metrics
...
if __name__ == "__main__":
    ...
    print("1. Simplified_Parallel_Coordinates.png - Clean 3-metric comparison")
